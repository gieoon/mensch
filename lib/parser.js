...
function parseSelector(token) {
  ...
  return astNode(token, {
    ...
    // Also case for: -o-transition:.3s all;transition:all .3s;will-change:margin-inline-start}.e-container>.e-container>.elementor-element-overlay>.elementor-editor-element-settings:hover>:is(.elementor-editor-element-duplicate,.elementor-editor-element-remove),.elementor-widget .e-container>.elementor-element-overlay>.elementor-editor-element-settings:hover>:is(.elementor-editor-element-duplicate,.elementor-editor-element-remove){-webkit-margin-start:0;margin-inline-start:0}
    // Also removing undefined for selector: e.g. Section,body > main > div.relative.overflow-hidden > div.container
...
function parseToken(token) {
  ...
  console.log(debug('parseToken: unexpected token:', JSON.stringify(token)));
}
